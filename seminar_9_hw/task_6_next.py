...
1.1. Напишите следующие функции:
...
from functools import wraps # для задания №6
...
@save_to_json
@from_csv_wrap('data/rand_num.csv')
# Нахождение корней квадратного уравнения
...
# Генерация csv файла с тремя случайными числами в каждой строке. 100-1000 строк.
def gen_csv_with_nums(name: str = 'data/rand_num', min_num: int = -1000, max_num: int = 1000):
    rows = []
