...
def group_file_in_dir(dir_source: str, dir_result: str):
    ...
    folder_track = Path(Path.cwd() / dir_source)          #C:\Users\sonym\new_project\venv\result\new
    folder_move = Path(Path.cwd() / dir_result)           #C:\Users\sonym\new_project\venv\result
